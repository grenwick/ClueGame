...
public class BoardAdjTargetTest306 {
	...
	public void testTargetsInDiningRoom() {
		// test a roll of 1
		board.startCalcTargets(board.getCell(12, 20), 1);
		...
		// test a roll of 3
		board.startCalcTargets(board.getCell(12, 20), 3);
		...
		// test a roll of 4
		board.startCalcTargets(board.getCell(12, 20), 4);
		targets= board.getTargets();
	...
	public void testTargetsInKitchen() {
		// test a roll of 1
		board.startCalcTargets(board.getCell(20, 19), 1);
		Set<BoardCell> targets= board.getTargets();
		assertEquals(2, targets.size());
		...
		// test a roll of 3
		board.startCalcTargets(board.getCell(20, 19), 3);
		targets= board.getTargets();
		...
		// test a roll of 4
		board.startCalcTargets(board.getCell(20, 19), 4);
		targets= board.getTargets();
		assertEquals(9, targets.size());
	...
	public void testTargetsAtDoor() {
		...
		board.startCalcTargets(board.getCell(8, 17), 1);
		Set<BoardCell> targets= board.getTargets();
		...
		// test a roll of 3
		board.startCalcTargets(board.getCell(8, 17), 3);
		targets= board.getTargets();
		...
		// test a roll of 4
		board.startCalcTargets(board.getCell(8, 17), 4);
		targets= board.getTargets();
	...
	public void testTargetsInWalkway1() {
		// test a roll of 1
		board.startCalcTargets(board.getCell(11, 2), 1);
		Set<BoardCell> targets= board.getTargets();
		assertEquals(2, targets.size());
		...
		// test a roll of 3
		board.startCalcTargets(board.getCell(11, 2), 3);
		targets= board.getTargets();
		...
		// test a roll of 4
		board.startCalcTargets(board.getCell(11, 2), 4);
		targets= board.getTargets();
		assertEquals(3, targets.size());
		assertTrue(targets.contains(board.getCell(14, 2)));
		assertTrue(targets.contains(board.getCell(8, 2)));
	...
	public void testTargetsInWalkway2() {
		// test a roll of 1
		board.startCalcTargets(board.getCell(13, 7), 1);
		Set<BoardCell> targets= board.getTargets();
		assertEquals(4, targets.size());
		...
		// test a roll of 3
		board.startCalcTargets(board.getCell(13, 7), 3);
		targets= board.getTargets();
		...
		// test a roll of 4
		board.startCalcTargets(board.getCell(13, 7), 4);
		targets= board.getTargets();
		assertEquals(15, targets.size());
		assertTrue(targets.contains(board.getCell(14, 2)));
